...
def print_results(results_dic, results_stats_dic, model,
    ...
    """
    # print neural newtork model architecture
    print('CNN model architecture: {}\n'.format(model))
    # print images statistics count
    print('DATA SET COUNTS\n- Number of Immages: {}\n- Number of Dog Images: {}\n- Number of "Not-a" Dog Images: {}\n'.format(
      results_stats_dic['n_images'],
      results_stats_dic['n_dogs_img'],
      results_stats_dic['n_notdogs_img']))
    # print images percentage statistics
    print('DATA SET STATS\n- Correct Dogs: {}%\n- Correct Breed: {}%\n- Correct "Not-a" Dog: {}%\n- Match: {}%\n'.format(
      ...
      round(results_stats_dic['pct_match'], 1)))

    # print misclassified dogs 
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
      print('Misclassified Dogs\n'.upper())
      for key in results_dic:
        incorrect_dogs = sum(results_dic[key][3:])
        if incorrect_dogs == 1:
          print('Pet image label: {}\nMisclassified label: {}\n'.format(results_dic[key][0], results_dic[key][1]))

    # misclassified breed's of dog
    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
      print("misclassified breed's of dog\n".upper())
      for key in results_dic:
        misclassified_breeds1 =  sum(results_dic[key][3:])
        misclassified_breeds2 = results_dic[key][2]
        if misclassified_breeds1 == 2 and misclassified_breeds2 == 0:
          print('Pet image label: {}\nMisclassified label: {}\n'.format(results_dic[key][0], results_dic[key][1]))
    None
